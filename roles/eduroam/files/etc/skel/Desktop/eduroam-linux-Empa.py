...
class Messages(object):
    ...
    """
    quit = "Really quit?"
    username_prompt = "enter your userid (email address)"
...
Config.instname = "Empa"
Config.profilename = "Employees"
Config.url = "https://www.empa.ch/it"
Config.email = "ICTContact@empa.ch"
Config.title = "eduroam CAT"
Config.server_match = "ee.emp-eaw.ch"
...
Config.user_realm = "empa.ch"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:ee-radius1.ee.emp-eaw.ch', 'DNS:ee-radius2.ee.emp-eaw.ch']
Config.use_other_tls_id = False
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

L+9oHT+BmuFN5+5TmLGJCpL1ZCYfHYCUh66A904zcjKxY5MJ
-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
run_installer()
